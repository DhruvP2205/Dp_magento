 ...
 */
class Dp_Product_Block_Adminhtml_Product_Index_Edit_Gallary extends Varien_Data_Form_Element_Abstract
{
    ...
    public function getContentHtml()
    {
        ...
        $content = Mage::getSingleton('core/layout')
            ->createBlock('adminhtml/Product_Index_Edit_Tab_Media');
